              ...
              content: {
                "application/json": {
                  schema: {
                    type: "object",
                    properties: {
                      data: { type: "array", items: { $ref: "#/components/schemas/Design" } },
                    },
                  },
                },
              },
        ...
        post: {
          ...
          responses: {
            201: {
              ...
              content: { "application/json": { schema: { $ref: "#/components/schemas/Design" } } },
            },
            400: { $ref: "#/components/responses/BadRequest" },
                ...
                "application/json": {
                  schema: {
                    ...
                    properties: {
                      data: {
                        type: "array",
                        items: { $ref: "#/components/schemas/InspirationItem" },
                      },
                    },
                  },
                },
